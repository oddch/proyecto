...
public class Mailer {
      public static void sendClaves(String para, String Nombres, String correoUsu, String clave) {
        final String user = "ficha1365301b@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "Sena1234";
...
//2nd paso)compose message
        try {
            ...
            message.setSubject("Recordatorio claves proyecto Base");
...
//2nd paso)compose message
        try {
            ...
            message.setContent(
                    "<center><img src='' title='XXX'></center>"
                    + "<h3> Actualizacion de datos en XXXX "
                    + Nombres
                    + "</h3>"
                    + "Datos de Ingreso: "
                    + "<h4> Nombre Usuario : "
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Bienvenido sistema ADSI.");
